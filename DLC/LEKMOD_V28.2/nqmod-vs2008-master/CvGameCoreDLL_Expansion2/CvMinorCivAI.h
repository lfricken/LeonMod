...
#define QUEST_GIFT_GREAT_PERSON MINOR_CIV_QUEST_GREAT_PERSON // text updated

#define QUEST_BUILD_NATIONAL_WONDER MINOR_CIV_QUEST_FIND_NATURAL_WONDER // text updated
#define QUEST_GIFT_GOLD MINOR_CIV_QUEST_GIVE_GOLD // text updated
#define QUEST_GIFT_MILITARY MINOR_CIV_QUEST_PLEDGE_TO_PROTECT // text updated

#define QUEST_GIFT_WORKER MINOR_CIV_QUEST_CONTEST_CULTURE // text updated
#define QUEST_SPREAD_RELIGION MINOR_CIV_QUEST_SPREAD_RELIGION // text updated
#define QUEST_TRADE_ROUTE MINOR_CIV_QUEST_TRADE_ROUTE // text updated
...
enum MinorCivQuestTypes
{
	...
	QUEST_BUILD_WORLD_WONDER,
	// gift us a great person
	QUEST_GIFT_GREAT_PERSON,
	// unused
    MINOR_CIV_QUEST_KILL_CITY_STATE,
	// unused
    MINOR_CIV_QUEST_FIND_PLAYER,
	// build national wonder
	QUEST_BUILD_NATIONAL_WONDER,
	// gift gold
	QUEST_GIFT_GOLD,
	// gift military unit
	QUEST_GIFT_MILITARY,
	...
	// spread religion here
	QUEST_SPREAD_RELIGION,

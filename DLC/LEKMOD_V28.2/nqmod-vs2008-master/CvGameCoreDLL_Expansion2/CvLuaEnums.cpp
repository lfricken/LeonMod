...
int CvLuaEnums::pRegister(lua_State* L)
{
	...
	RegisterEnum(COMPETITION_GOLD_GIFTS);
	RegisterEnum(COMPETITION_NUCLEAR_STOCKPILE);

	RegisterEnum(COMPETITION_DIPLOMATIC_END);
	RegisterEnum(COMPETITION_SCIENCE_START);

	RegisterEnum(COMPETITION_SCIENCE_SPECIALISTS);
	...
	RegisterEnum(YIELD_GOLDEN);

	RegisterEnum(YIELD_TOURISM);
	RegisterEnum(YIELD_SCIENTIFIC_INSIGHT);
	RegisterEnum(YIELD_DIPLOMATIC_SUPPORT);
	...
	RegisterEnum(TRADE_ITEM_CARD);
	RegisterEnum(TRADE_ITEM_LUMP);

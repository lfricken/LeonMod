...
public:
	...
	// in online turns, indicates the percentage [0,100]
	T100 turnsToPercentageT10000(int start, int end);
	// [0, 10000] Number of turns DONE as a percentage of max turns 
	T100 getPercentTurnsDoneT10000();
	...
	inline T100 getAI_STRATEGY_NEED_IMPROVEMENT_CITY_RATIOT100()
	{
	...
	inline T100 getAI_CITYSTRATEGY_YIELD_DEFICIENT_FOODT100()
	{
		return m_fAI_CITYSTRATEGY_YIELD_DEFICIENT_FOOD;
	}
	inline T100 getAI_CITYSTRATEGY_YIELD_DEFICIENT_PRODUCTIONT100()
	{
		return m_fAI_CITYSTRATEGY_YIELD_DEFICIENT_PRODUCTION;
	}
	inline T100 getAI_CITYSTRATEGY_YIELD_DEFICIENT_GOLDT100()
	{
		return m_fAI_CITYSTRATEGY_YIELD_DEFICIENT_GOLD;
	}
	inline T100 getAI_CITYSTRATEGY_YIELD_DEFICIENT_SCIENCET100()
	{
	...
	inline int getMINOR_STRENGTH_FOR_INFLUENCE() const
	{
		return m_iMINOR_STRENGTH_FOR_INFLUENCE;
	}
	...
	/** We aren't allowed to make gold purchases that would take us beyond this friendship level. */
	inline int getMINOR_CIV_GOLD_GIFT_MINIMUM_FRIENDSHIP_REWARD()
	{
		return m_iMINOR_CIV_GOLD_GIFT_MINIMUM_FRIENDSHIP_REWARD;
	}
	inline int getMINOR_CIV_MAX_GOLD_FRIENDSHIP()
	{
		return m_iMINOR_CIV_MAX_GOLD_FRIENDSHIP;
	}
	...
	inline T100 getNORMAL_ANNEXT100()
	{
		return m_fNORMAL_ANNEX;
	}
	inline T100 getAGGRESIVE_ANNEXT100()
	{
	...
	// /*134*/
	inline T100 getUNHAPPINESS_PER_OCCUPIED_POPULATIONT100()
	{
	...
	inline T100 getGOLDEN_AGE_THRESHOLD_CITY_MULTIPLIERT100()
	{
	...
	inline int getCITY_STRENGTH_HILL_CHANGET100()
	{
	...
	inline int getCITY_STRENGTH_TECH_MULTIPLIERT100()
	{
	...
	inline T100 getINTERCEPTION_DAMAGE_MULTIPLIERT100()
	{
		return m_fINTERCEPTION_DAMAGE_MULTIPLIER;
	}
	// max percentage of tourism adjustment to combat strength, 15% would return as (int)15
	inline T100 getTOURISM_COMBAT_MAXT100()
	{
		return m_fTOURISM_COMBAT_MAX;
	}

	inline T100 getTOURISM_COMBAT_DIVISORT100()
	{
		return m_fTOURISM_COMBAT_DIVISOR;
	}
	inline T100 getDIPLO_VICTORY_CIV_DELEGATES_COEFFICIENTT100()
	{
		return m_fDIPLO_VICTORY_CIV_DELEGATES_COEFFICIENT;
	}
	inline T100 getDIPLO_VICTORY_CIV_DELEGATES_CONSTANTT100()
	{
		return m_fDIPLO_VICTORY_CIV_DELEGATES_CONSTANT;
	}
	inline T100 getDIPLO_VICTORY_CS_DELEGATES_COEFFICIENTT100()
	{
		return m_fDIPLO_VICTORY_CS_DELEGATES_COEFFICIENT;
	}
	inline T100 getDIPLO_VICTORY_CS_DELEGATES_CONSTANTT100()
	{
		return m_fDIPLO_VICTORY_CS_DELEGATES_CONSTANT;
	}
	inline T100 getAI_PRODUCTION_WEIGHT_MOD_PER_TURN_LEFTT100()
	{
		return m_fAI_PRODUCTION_WEIGHT_MOD_PER_TURN_LEFT;
	}
	inline T100 getAI_PRODUCTION_WEIGHT_BASE_MODT100()
	{
		return m_fAI_PRODUCTION_WEIGHT_BASE_MOD;
	}
	inline T100 getAI_RESEARCH_WEIGHT_MOD_PER_TURN_LEFTT100()
	{
		return m_fAI_RESEARCH_WEIGHT_MOD_PER_TURN_LEFT;
	}
	inline T100 getAI_RESEARCH_WEIGHT_BASE_MODT100()
	{
		return m_fAI_RESEARCH_WEIGHT_BASE_MOD;
	}
	inline T100 getHURRY_GOLD_PRODUCTION_EXPONENTT100()
	{
		return m_fHURRY_GOLD_PRODUCTION_EXPONENT;
	}
	inline T100 getCITY_ZOOM_LEVEL_1T100()
	{
		return m_fCITY_ZOOM_LEVEL_1;
	}
	inline T100 getCITY_ZOOM_LEVEL_2T100()
	{
		return m_fCITY_ZOOM_LEVEL_2;
	}
	inline T100 getCITY_ZOOM_LEVEL_3T100()
	{
		return m_fCITY_ZOOM_LEVEL_3;
	}
	inline T100 getCITY_ZOOM_OFFSETT100()
	{
		return m_fCITY_ZOOM_OFFSET;
	}
	inline T100 getCULTURE_COST_LATER_PLOT_EXPONENTT100()
	{
		return m_fCULTURE_COST_LATER_PLOT_EXPONENT;
	}
	inline T100 getPOST_COMBAT_TEXT_DELAYT100()
	{
		return m_fPOST_COMBAT_TEXT_DELAY;
	}
	inline T100 getAI_CITY_SPECIALIZATION_PRODUCTION_WEIGHT_NEXT_WONDERT100()
	{
		return m_fAI_CITY_SPECIALIZATION_PRODUCTION_WEIGHT_NEXT_WONDER;
	}
	inline T100 getAI_DANGER_MAJOR_APPROACH_WART100()
	{
		return m_fAI_DANGER_MAJOR_APPROACH_WAR;
	}
	inline T100 getAI_DANGER_MAJOR_APPROACH_HOSTILET100()
	{
		return m_fAI_DANGER_MAJOR_APPROACH_HOSTILE;
	}
	inline T100 getAI_DANGER_MAJOR_APPROACH_DECEPTIVET100()
	{
		return m_fAI_DANGER_MAJOR_APPROACH_DECEPTIVE;
	}
	inline T100 getAI_DANGER_MAJOR_APPROACH_GUARDEDT100()
	{
		return m_fAI_DANGER_MAJOR_APPROACH_GUARDED;
	}
	inline T100 getAI_DANGER_MAJOR_APPROACH_AFRAIDT100()
	{
		return m_fAI_DANGER_MAJOR_APPROACH_AFRAID;
	}
	inline T100 getAI_DANGER_MAJOR_APPROACH_FRIENDLYT100()
	{
		return m_fAI_DANGER_MAJOR_APPROACH_FRIENDLY;
	}
	inline T100 getAI_DANGER_MAJOR_APPROACH_NEUTRALT100()
	{
		return m_fAI_DANGER_MAJOR_APPROACH_NEUTRAL;
	}
	inline T100 getAI_DANGER_MINOR_APPROACH_NEUTRALT100()
	{
		return m_fAI_DANGER_MINOR_APPROACH_NEUTRAL;
	}
	inline T100 getAI_DANGER_MINOR_APPROACH_FRIENDLYT100()
	{
		return m_fAI_DANGER_MINOR_APPROACH_FRIENDLY;
	}
	inline T100 getAI_DANGER_MINOR_APPROACH_BULLYT100()
	{
		return m_fAI_DANGER_MINOR_APPROACH_BULLY;
	}
	inline T100 getAI_DANGER_MINOR_APPROACH_CONQUESTT100()
	{
		return m_fAI_DANGER_MINOR_APPROACH_CONQUEST;
	}
	inline T100 getFLAVOR_STANDARD_LOG10_TILES_PER_PLAYERT100()
	{
		return m_fFLAVOR_STANDARD_LOG10_TILES_PER_PLAYER;
	}
	inline T100 getDIPLO_VICTORY_TEAM_MULTIPLIERT100()
	{
		return m_fDIPLO_VICTORY_TEAM_MULTIPLIER;
	}
	inline T100 getAI_TACTICAL_FLAVOR_DAMPENING_FOR_MOVE_PRIORITIZATIONT100()
	{
		return m_fAI_TACTICAL_FLAVOR_DAMPENING_FOR_MOVE_PRIORITIZATION;
	}
	inline T100 getAI_STRATEGY_DEFEND_MY_LANDS_UNITS_PER_CITYT100()
	{
		return m_fAI_STRATEGY_DEFEND_MY_LANDS_UNITS_PER_CITY;
	}
	inline T100 getAI_STRATEGY_NAVAL_UNITS_PER_CITYT100()
	{
		return m_fAI_STRATEGY_NAVAL_UNITS_PER_CITY;
	}
	inline T100 getGOLD_GIFT_FRIENDSHIP_EXPONENTT100()
	{
		return m_fGOLD_GIFT_FRIENDSHIP_EXPONENT;
	}
	inline T100 getGOLD_GIFT_FRIENDSHIP_DIVISORT100()
	{
		return m_fGOLD_GIFT_FRIENDSHIP_DIVISOR;
	}
	inline T100 getHURRY_GOLD_TECH_EXPONENTT100()
	{
		return m_fHURRY_GOLD_TECH_EXPONENT;
	}
	inline T100 getHURRY_GOLD_CULTURE_EXPONENTT100()
	{
		return m_fHURRY_GOLD_CULTURE_EXPONENT;
	}
	inline T100 getCITY_GROWTH_MULTIPLIERT100()
	{
		return m_fCITY_GROWTH_MULTIPLIER;
	}
	inline T100 getCITY_GROWTH_EXPONENTT100()
	{
		return m_fCITY_GROWTH_EXPONENT;
	}
	inline T100 getPOLICY_COST_EXPONENTT100()
	{
		return m_fPOLICY_COST_EXPONENT;
	}
	inline T100 getPOLICY_COST_MULTIPLIERT100()
	{
		return m_fPOLICY_COST_MULTIPLIER;
	}
	inline T100 getUNIT_UPGRADE_COST_MULTIPLIER_PER_ERAT100()
	{
		return m_fUNIT_UPGRADE_COST_MULTIPLIER_PER_ERA;
	}
	inline T100 getUNIT_UPGRADE_COST_EXPONENTT100()
	{
		return m_fUNIT_UPGRADE_COST_EXPONENT;
	}
	inline T100 getCITY_STRENGTH_TECH_BASET100()
	{
		return m_fCITY_STRENGTH_TECH_BASE;
	}
	inline T100 getCITY_STRENGTH_TECH_EXPONENTT100()
	{
	...
	inline T100 getESPIONAGE_COUP_MULTIPLY_CONSTANTT100()
	{
		return m_fESPIONAGE_COUP_MULTIPLY_CONSTANT;
	}
	inline T100 getESPIONAGE_COUP_SPY_LEVEL_DELTA_ZEROT100()
	{
		return m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_ZERO;
	}
	inline T100 getESPIONAGE_COUP_SPY_LEVEL_DELTA_ONET100()
	{
		return m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_ONE;
	}
	inline T100 getESPIONAGE_COUP_SPY_LEVEL_DELTA_TWOT100()
	{
		return m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_TWO;
	}
	inline T100 getESPIONAGE_COUP_SPY_LEVEL_DELTA_THREET100()
	{
		return m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_THREE;
	}
	inline T100 getESPIONAGE_COUP_SPY_LEVEL_DELTA_FOURT100()
	{
	...
	inline T100 getUNRESEARCHED_TECH_BONUS_FROM_KILLS_SLOPET100()
	{
		return m_fUNRESEARCHED_TECH_FROM_KILLS_SLOPE;
	}
	inline T100 getUNRESEARCHED_TECH_BONUS_FROM_KILLS_INTERCEPTT100()
	{
	...
	inline T100 getLEAGUE_PROJECT_REWARD_TIER_1_THRESHOLDT100()
	{
		return m_fLEAGUE_PROJECT_REWARD_TIER_1_THRESHOLD;
	}
	inline T100 getLEAGUE_PROJECT_REWARD_TIER_2_THRESHOLDT100()
	{
...
protected:
	...
	************************************************************************************************************************/
	...
	int m_fAI_STRATEGY_NEED_IMPROVEMENT_CITY_RATIO;
	...
	int m_fAI_CITYSTRATEGY_YIELD_DEFICIENT_FOOD;
	int m_fAI_CITYSTRATEGY_YIELD_DEFICIENT_PRODUCTION;
	int m_fAI_CITYSTRATEGY_YIELD_DEFICIENT_GOLD;
	int m_fAI_CITYSTRATEGY_YIELD_DEFICIENT_SCIENCE;
	...
	int m_iMINOR_STRENGTH_FOR_INFLUENCE;
	...
	int m_iMINOR_CIV_MAX_GOLD_FRIENDSHIP;
	...
	int m_fUNHAPPINESS_PER_OCCUPIED_POPULATION;
	...
	int m_fGOLDEN_AGE_THRESHOLD_CITY_MULTIPLIER;
	...
	int m_iMAX_CITY_HIT_POINTS_AI_BONUS;
	...
	int m_fINTERCEPTION_DAMAGE_MULTIPLIER;
	int m_fTOURISM_COMBAT_MAX;
	int m_fTOURISM_COMBAT_DIVISOR;
	int m_fDIPLO_VICTORY_CIV_DELEGATES_COEFFICIENT;
	int m_fDIPLO_VICTORY_CIV_DELEGATES_CONSTANT;
	int m_fDIPLO_VICTORY_CS_DELEGATES_COEFFICIENT;
	int m_fDIPLO_VICTORY_CS_DELEGATES_CONSTANT;
	int m_fAI_PRODUCTION_WEIGHT_MOD_PER_TURN_LEFT;
	int m_fAI_PRODUCTION_WEIGHT_BASE_MOD;
	int m_fAI_RESEARCH_WEIGHT_MOD_PER_TURN_LEFT;
	int m_fAI_RESEARCH_WEIGHT_BASE_MOD;
	int m_fHURRY_GOLD_PRODUCTION_EXPONENT;
	int m_fCITY_ZOOM_LEVEL_1;
	int m_fCITY_ZOOM_LEVEL_2;
	int m_fCITY_ZOOM_LEVEL_3;
	int m_fCITY_ZOOM_OFFSET;
	int m_fCULTURE_COST_LATER_PLOT_EXPONENT;
	int m_fPOST_COMBAT_TEXT_DELAY;
	int m_fAI_CITY_SPECIALIZATION_PRODUCTION_WEIGHT_NEXT_WONDER;
	int m_fAI_DANGER_MAJOR_APPROACH_WAR;
	int m_fAI_DANGER_MAJOR_APPROACH_HOSTILE;
	int m_fAI_DANGER_MAJOR_APPROACH_DECEPTIVE;
	int m_fAI_DANGER_MAJOR_APPROACH_GUARDED;
	int m_fAI_DANGER_MAJOR_APPROACH_AFRAID;
	int m_fAI_DANGER_MAJOR_APPROACH_FRIENDLY;
	int m_fAI_DANGER_MAJOR_APPROACH_NEUTRAL;
	int m_fAI_DANGER_MINOR_APPROACH_NEUTRAL;
	int m_fAI_DANGER_MINOR_APPROACH_FRIENDLY;
	int m_fAI_DANGER_MINOR_APPROACH_BULLY;
	int m_fAI_DANGER_MINOR_APPROACH_CONQUEST;
	int m_fFLAVOR_STANDARD_LOG10_TILES_PER_PLAYER;
	int m_fDIPLO_VICTORY_TEAM_MULTIPLIER;
	int m_fAI_TACTICAL_FLAVOR_DAMPENING_FOR_MOVE_PRIORITIZATION;
	int m_fAI_STRATEGY_DEFEND_MY_LANDS_UNITS_PER_CITY;
	int m_fAI_STRATEGY_NAVAL_UNITS_PER_CITY;
	int m_fGOLD_GIFT_FRIENDSHIP_EXPONENT;
	int m_fGOLD_GIFT_FRIENDSHIP_DIVISOR;
	int m_fHURRY_GOLD_TECH_EXPONENT;
	int m_fHURRY_GOLD_CULTURE_EXPONENT;
	int m_fCITY_GROWTH_MULTIPLIER;
	int m_fCITY_GROWTH_EXPONENT;
	int m_fPOLICY_COST_EXPONENT;
	int m_fPOLICY_COST_MULTIPLIER;
	int m_fUNIT_UPGRADE_COST_MULTIPLIER_PER_ERA;
	int m_fUNIT_UPGRADE_COST_EXPONENT;
	int m_fCITY_STRENGTH_TECH_BASE;
	int m_fCITY_STRENGTH_TECH_EXPONENT;
	int m_fESPIONAGE_COUP_NOBODY_BONUS;
	int m_fESPIONAGE_COUP_MULTIPLY_CONSTANT;
	int m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_ZERO;
	int m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_ONE;
	int m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_TWO;
	int m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_THREE;
	int m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_FOUR;
	int   m_iPILLAGE_HEAL_AMOUNT;
	int   m_iCITY_CONNECTIONS_CONNECT_TO_CAPITAL;
	int m_fNORMAL_ANNEX;
	int m_fAGGRESSIVE_ANNEX;
	int m_fUNRESEARCHED_TECH_FROM_KILLS_SLOPE;
	int m_fUNRESEARCHED_TECH_FROM_KILLS_INTERCEPT;
	...
	int   m_fLEAGUE_PROJECT_REWARD_TIER_1_THRESHOLD;
	int   m_fLEAGUE_PROJECT_REWARD_TIER_2_THRESHOLD;

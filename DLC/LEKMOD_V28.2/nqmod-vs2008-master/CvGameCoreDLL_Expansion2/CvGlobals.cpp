...
void addColoredValue(stringstream& s, const long value, const string description, const bool includePercentSymbol, const bool includeNewline, const char zeroSymbol)
{
	const long absValue = abs(value);
	if (value > 0)      s << "[COLOR_POSITIVE_TEXT]+" << absValue;
	else if (value < 0) s << "[COLOR_NEGATIVE_TEXT]-" << absValue;
	else				s << "[COLOR_GREY]" << zeroSymbol << absValue;
...
// -- ints --
	...
	m_fAI_STRATEGY_NEED_IMPROVEMENT_CITY_RATIO(34),
	...
	m_fAI_CITYSTRATEGY_YIELD_DEFICIENT_FOOD(200),
	m_fAI_CITYSTRATEGY_YIELD_DEFICIENT_PRODUCTION(80),
	m_fAI_CITYSTRATEGY_YIELD_DEFICIENT_GOLD(0),
	m_fAI_CITYSTRATEGY_YIELD_DEFICIENT_SCIENCE(0),
	...
	m_iMINOR_STRENGTH_FOR_INFLUENCE(20),
	...
	m_iMINOR_CIV_MAX_GOLD_FRIENDSHIP(200),
	...
	m_fUNHAPPINESS_PER_OCCUPIED_POPULATION(134),
	...
	m_fGOLDEN_AGE_THRESHOLD_CITY_MULTIPLIER(0),
	...
	m_iMAX_CITY_HIT_POINTS_AI_BONUS(300),
	...
	m_iBUILDING_COST_VARIATION_T100(35),
	m_iPLOT_YIELD_VARIATION_T100(30),

// -- fdloats --

	m_fINTERCEPTION_DAMAGE_MULTIPLIER(50),
	m_fTOURISM_COMBAT_MAX(15),
	m_fTOURISM_COMBAT_DIVISOR(100),
	m_fDIPLO_VICTORY_CIV_DELEGATES_COEFFICIENT(144),
	m_fDIPLO_VICTORY_CIV_DELEGATES_CONSTANT(700),
	m_fDIPLO_VICTORY_CS_DELEGATES_COEFFICIENT(1602),
	m_fDIPLO_VICTORY_CS_DELEGATES_CONSTANT(-1374),
	m_fAI_PRODUCTION_WEIGHT_MOD_PER_TURN_LEFT(1),
	m_fAI_PRODUCTION_WEIGHT_BASE_MOD(15),
	m_fAI_RESEARCH_WEIGHT_MOD_PER_TURN_LEFT(1),
	m_fAI_RESEARCH_WEIGHT_BASE_MOD(15),
	m_fHURRY_GOLD_PRODUCTION_EXPONENT(95),
	m_fCITY_ZOOM_LEVEL_1(50000),
	m_fCITY_ZOOM_LEVEL_2(70000),
	m_fCITY_ZOOM_LEVEL_3(80000),
	m_fCITY_ZOOM_OFFSET(2000),
	m_fCULTURE_COST_LATER_PLOT_EXPONENT(110),
	m_fPOST_COMBAT_TEXT_DELAY(100),
	m_fAI_CITY_SPECIALIZATION_PRODUCTION_WEIGHT_NEXT_WONDER(100),
	m_fAI_DANGER_MAJOR_APPROACH_WAR(100),
	m_fAI_DANGER_MAJOR_APPROACH_HOSTILE(20),
	m_fAI_DANGER_MAJOR_APPROACH_DECEPTIVE(10),
	m_fAI_DANGER_MAJOR_APPROACH_GUARDED(50),
	m_fAI_DANGER_MAJOR_APPROACH_AFRAID(90),
	m_fAI_DANGER_MAJOR_APPROACH_FRIENDLY(0),
	m_fAI_DANGER_MAJOR_APPROACH_NEUTRAL(10),
	m_fAI_DANGER_MINOR_APPROACH_NEUTRAL(10),
	m_fAI_DANGER_MINOR_APPROACH_FRIENDLY(0),
	m_fAI_DANGER_MINOR_APPROACH_BULLY(90),
	m_fAI_DANGER_MINOR_APPROACH_CONQUEST(100),
	m_fFLAVOR_STANDARD_LOG10_TILES_PER_PLAYER(210),
	m_fDIPLO_VICTORY_TEAM_MULTIPLIER(110),
	m_fAI_TACTICAL_FLAVOR_DAMPENING_FOR_MOVE_PRIORITIZATION(30),
	m_fAI_STRATEGY_DEFEND_MY_LANDS_UNITS_PER_CITY(100),
	m_fAI_STRATEGY_NAVAL_UNITS_PER_CITY(67),
	m_fGOLD_GIFT_FRIENDSHIP_EXPONENT(101),
	m_fGOLD_GIFT_FRIENDSHIP_DIVISOR(630),
	m_fHURRY_GOLD_TECH_EXPONENT(110),
	m_fHURRY_GOLD_CULTURE_EXPONENT(110),
	m_fCITY_GROWTH_MULTIPLIER(600),
	m_fCITY_GROWTH_EXPONENT(180),
	m_fPOLICY_COST_EXPONENT(170),
	m_fPOLICY_COST_MULTIPLIER(100),
	m_fUNIT_UPGRADE_COST_MULTIPLIER_PER_ERA(0),
	m_fUNIT_UPGRADE_COST_EXPONENT(100),
	m_fCITY_STRENGTH_TECH_BASE(500),
	m_fCITY_STRENGTH_TECH_EXPONENT(180),
	m_fESPIONAGE_COUP_NOBODY_BONUS(100),
	m_fESPIONAGE_COUP_MULTIPLY_CONSTANT(100),
	m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_ZERO(100),
	m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_ONE(100),
	m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_TWO(100),
	m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_THREE(100),
	m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_FOUR(100),
	m_iPILLAGE_HEAL_AMOUNT(25),
	m_iCITY_CONNECTIONS_CONNECT_TO_CAPITAL(1),
	m_fUNRESEARCHED_TECH_FROM_KILLS_SLOPE(968),
	m_fUNRESEARCHED_TECH_FROM_KILLS_INTERCEPT(-11407),
	...
	m_fLEAGUE_PROJECT_REWARD_TIER_1_THRESHOLD(50),
	m_fLEAGUE_PROJECT_REWARD_TIER_2_THRESHOLD(100),
...
T100 CvGlobals::getBUILDING_COST_VARIATION_T100() const
{
	return m_iBUILDING_COST_VARIATION_T100;
}
T100 CvGlobals::getPLOT_YIELD_VARIATION_T100() const
{
	return m_iPLOT_YIELD_VARIATION_T100;
}
...
{
	return 7 * 14; // every X by Y region should have a barb on average
}
...
T100 CvGlobals::turnsToPercentageT10000(int start, int end)
{
	const int startT10000 = start * (100 * 100);
	int turnsPastStartT10000 = max(0l, onePerOnlineSpeedTurnT10000() - startT10000);
	return min(1 * 100 * 100, (turnsPastStartT10000) / (end - start));
}
T100 CvGlobals::adjustForSpeedT100(YieldTypes type)
{
	T100 xmlValueT100 = this->getGame().getGameSpeedInfo().getConstructPercent();
	if (type == YIELD_FOOD)
		xmlValueT100 = this->getGame().getGameSpeedInfo().getGrowthPercent();
	else if (type == YIELD_PRODUCTION)
		xmlValueT100 = this->getGame().getGameSpeedInfo().getConstructPercent();
	else if (type == YIELD_GOLD)
		xmlValueT100 = this->getGame().getGameSpeedInfo().getGoldPercent();
	else if (type == YIELD_SCIENCE)
		xmlValueT100 = this->getGame().getGameSpeedInfo().getResearchPercent();
	else if (type == YIELD_CULTURE)
		xmlValueT100 = this->getGame().getGameSpeedInfo().getCulturePercent();
	else if (type == YIELD_FAITH)
		xmlValueT100 = this->getGame().getGameSpeedInfo().getFaithPercent();
...
void CvGlobals::cacheGlobals()
{
	...
	m_fAI_STRATEGY_NEED_IMPROVEMENT_CITY_RATIO = getDefineINT("AI_STRATEGY_NEED_IMPROVEMENT_CITY_RATIO");
	...
	m_fAI_CITYSTRATEGY_YIELD_DEFICIENT_FOOD = getDefineINT("AI_CITYSTRATEGY_YIELD_DEFICIENT_FOOD");
	m_fAI_CITYSTRATEGY_YIELD_DEFICIENT_PRODUCTION = getDefineINT("AI_CITYSTRATEGY_YIELD_DEFICIENT_PRODUCTION");
	m_fAI_CITYSTRATEGY_YIELD_DEFICIENT_GOLD = getDefineINT("AI_CITYSTRATEGY_YIELD_DEFICIENT_GOLD");
	m_fAI_CITYSTRATEGY_YIELD_DEFICIENT_SCIENCE = getDefineINT("AI_CITYSTRATEGY_YIELD_DEFICIENT_SCIENCE");
	...
	m_iMINOR_STRENGTH_FOR_INFLUENCE = getDefineINT("MINOR_STRENGTH_FOR_INFLUENCE");
	...
	m_iMINOR_CIV_MAX_GOLD_FRIENDSHIP = getDefineINT("MINOR_CIV_MAX_GOLD_FRIENDSHIP");
	...
	m_fNORMAL_ANNEX = getDefineINT("NORMAL_ANNEX");
	m_fAGGRESSIVE_ANNEX = getDefineINT("AGGRESSIVE_ANNEX");
	...
	m_fUNHAPPINESS_PER_OCCUPIED_POPULATION = getDefineINT("UNHAPPINESS_PER_OCCUPIED_POPULATION");
	...
	m_fGOLDEN_AGE_THRESHOLD_CITY_MULTIPLIER = getDefineINT("GOLDEN_AGE_THRESHOLD_CITY_MULTIPLIER");
	...
	m_iMAX_CITY_HIT_POINTS_AI_BONUS = getDefineINT("MAX_CITY_HIT_POINTS_AI_BONUS");
	...
	m_iBUILDING_COST_VARIATION_T100 = getDefineINT("BUILDING_COST_VARIATION_T100");
	m_iPLOT_YIELD_VARIATION_T100 = getDefineINT("PLOT_YIELD_VARIATION_T100");

	// -- fdloats --

	m_fINTERCEPTION_DAMAGE_MULTIPLIER = getDefineINT("INTERCEPTION_DAMAGE_MULTIPLIER");
	m_fTOURISM_COMBAT_MAX = getDefineINT("TOURISM_COMBAT_MAX");
	m_fTOURISM_COMBAT_DIVISOR = getDefineINT("TOURISM_COMBAT_DIVISOR");
	m_fDIPLO_VICTORY_CIV_DELEGATES_COEFFICIENT = getDefineINT("DIPLO_VICTORY_CIV_DELEGATES_COEFFICIENT");
	m_fDIPLO_VICTORY_CIV_DELEGATES_CONSTANT = getDefineINT("DIPLO_VICTORY_CIV_DELEGATES_CONSTANT");
	m_fDIPLO_VICTORY_CS_DELEGATES_COEFFICIENT = getDefineINT("DIPLO_VICTORY_CS_DELEGATES_COEFFICIENT");
	m_fDIPLO_VICTORY_CS_DELEGATES_CONSTANT = getDefineINT("DIPLO_VICTORY_CS_DELEGATES_CONSTANT");
	m_fAI_PRODUCTION_WEIGHT_MOD_PER_TURN_LEFT = getDefineINT("AI_PRODUCTION_WEIGHT_MOD_PER_TURN_LEFT");
	m_fAI_PRODUCTION_WEIGHT_BASE_MOD = getDefineINT("AI_PRODUCTION_WEIGHT_BASE_MOD");
	m_fAI_RESEARCH_WEIGHT_MOD_PER_TURN_LEFT = getDefineINT("AI_RESEARCH_WEIGHT_MOD_PER_TURN_LEFT");
	m_fAI_RESEARCH_WEIGHT_BASE_MOD = getDefineINT("AI_RESEARCH_WEIGHT_BASE_MOD");
	m_fHURRY_GOLD_PRODUCTION_EXPONENT = getDefineINT("HURRY_GOLD_PRODUCTION_EXPONENT");
	m_fCITY_ZOOM_LEVEL_1 = getDefineINT("CITY_ZOOM_LEVEL_1");
	m_fCITY_ZOOM_LEVEL_2 = getDefineINT("CITY_ZOOM_LEVEL_2");
	m_fCITY_ZOOM_LEVEL_3 = getDefineINT("CITY_ZOOM_LEVEL_3");
	m_fCITY_ZOOM_OFFSET = getDefineINT("CITY_ZOOM_OFFSET");
	m_fCULTURE_COST_LATER_PLOT_EXPONENT = getDefineINT("CULTURE_COST_LATER_PLOT_EXPONENT");
	m_fPOST_COMBAT_TEXT_DELAY = getDefineINT("POST_COMBAT_TEXT_DELAY");
	m_fAI_CITY_SPECIALIZATION_PRODUCTION_WEIGHT_NEXT_WONDER = getDefineINT("AI_CITY_SPECIALIZATION_PRODUCTION_WEIGHT_NEXT_WONDER");
	m_fAI_DANGER_MAJOR_APPROACH_WAR = getDefineINT("AI_DANGER_MAJOR_APPROACH_WAR");
	m_fAI_DANGER_MAJOR_APPROACH_HOSTILE = getDefineINT("AI_DANGER_MAJOR_APPROACH_HOSTILE");
	m_fAI_DANGER_MAJOR_APPROACH_DECEPTIVE = getDefineINT("AI_DANGER_MAJOR_APPROACH_DECEPTIVE");
	m_fAI_DANGER_MAJOR_APPROACH_GUARDED = getDefineINT("AI_DANGER_MAJOR_APPROACH_GUARDED");
	m_fAI_DANGER_MAJOR_APPROACH_AFRAID = getDefineINT("AI_DANGER_MAJOR_APPROACH_AFRAID");
	m_fAI_DANGER_MAJOR_APPROACH_FRIENDLY = getDefineINT("AI_DANGER_MAJOR_APPROACH_FRIENDLY");
	m_fAI_DANGER_MAJOR_APPROACH_NEUTRAL = getDefineINT("AI_DANGER_MAJOR_APPROACH_NEUTRAL");
	m_fAI_DANGER_MINOR_APPROACH_NEUTRAL = getDefineINT("AI_DANGER_MINOR_APPROACH_NEUTRAL");
	m_fAI_DANGER_MINOR_APPROACH_FRIENDLY = getDefineINT("AI_DANGER_MINOR_APPROACH_FRIENDLY");
	m_fAI_DANGER_MINOR_APPROACH_BULLY = getDefineINT("AI_DANGER_MINOR_APPROACH_BULLY");
	m_fAI_DANGER_MINOR_APPROACH_CONQUEST = getDefineINT("AI_DANGER_MINOR_APPROACH_CONQUEST");
	m_fFLAVOR_STANDARD_LOG10_TILES_PER_PLAYER = getDefineINT("FLAVOR_STANDARD_LOG10_TILES_PER_PLAYER");
	m_fDIPLO_VICTORY_TEAM_MULTIPLIER = getDefineINT("DIPLO_VICTORY_TEAM_MULTIPLIER");
	m_fAI_TACTICAL_FLAVOR_DAMPENING_FOR_MOVE_PRIORITIZATION = getDefineINT("AI_TACTICAL_FLAVOR_DAMPENING_FOR_MOVE_PRIORITIZATION");
	m_fAI_STRATEGY_DEFEND_MY_LANDS_UNITS_PER_CITY = getDefineINT("AI_STRATEGY_DEFEND_MY_LANDS_UNITS_PER_CITY");
	m_fAI_STRATEGY_NAVAL_UNITS_PER_CITY = getDefineINT("AI_STRATEGY_NAVAL_UNITS_PER_CITY");
	m_fGOLD_GIFT_FRIENDSHIP_EXPONENT = getDefineINT("GOLD_GIFT_FRIENDSHIP_EXPONENT");
	m_fGOLD_GIFT_FRIENDSHIP_DIVISOR = getDefineINT("GOLD_GIFT_FRIENDSHIP_DIVISOR");
	m_fHURRY_GOLD_TECH_EXPONENT = getDefineINT("HURRY_GOLD_TECH_EXPONENT");
	m_fHURRY_GOLD_CULTURE_EXPONENT = getDefineINT("HURRY_GOLD_CULTURE_EXPONENT");
	m_fCITY_GROWTH_MULTIPLIER = getDefineINT("CITY_GROWTH_MULTIPLIER");
	m_fCITY_GROWTH_EXPONENT = getDefineINT("CITY_GROWTH_EXPONENT");
	m_fPOLICY_COST_EXPONENT = getDefineINT("POLICY_COST_EXPONENT");
	m_fPOLICY_COST_MULTIPLIER = getDefineINT("POLICY_COST_MULTIPLIER");
	m_fUNIT_UPGRADE_COST_MULTIPLIER_PER_ERA = getDefineINT("UNIT_UPGRADE_COST_MULTIPLIER_PER_ERA");
	m_fUNIT_UPGRADE_COST_EXPONENT = getDefineINT("UNIT_UPGRADE_COST_EXPONENT");
	m_fCITY_STRENGTH_TECH_BASE = getDefineINT("CITY_STRENGTH_TECH_BASE");
	m_fCITY_STRENGTH_TECH_EXPONENT = getDefineINT("CITY_STRENGTH_TECH_EXPONENT");
	m_fESPIONAGE_COUP_NOBODY_BONUS = getDefineINT("ESPIONAGE_COUP_NOBODY_BONUS");
	m_fESPIONAGE_COUP_MULTIPLY_CONSTANT = getDefineINT("ESPIONAGE_COUP_MULTIPLY_CONSTANT");
	m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_ZERO = getDefineINT("ESPIONAGE_COUP_SPY_LEVEL_DELTA_ZERO");
	m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_ONE = getDefineINT("ESPIONAGE_COUP_SPY_LEVEL_DELTA_ONE");
	m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_TWO = getDefineINT("ESPIONAGE_COUP_SPY_LEVEL_DELTA_TWO");
	m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_THREE = getDefineINT("ESPIONAGE_COUP_SPY_LEVEL_DELTA_THREE");
	m_fESPIONAGE_COUP_SPY_LEVEL_DELTA_FOUR = getDefineINT("ESPIONAGE_COUP_SPY_LEVEL_DELTA_FOUR");
	...
	m_fUNRESEARCHED_TECH_FROM_KILLS_SLOPE = getDefineINT("UNRESEARCHED_TECH_BONUS_FROM_KILLS_SLOPE");
	m_fUNRESEARCHED_TECH_FROM_KILLS_INTERCEPT = getDefineINT("UNRESEARCHED_TECH_BONUS_FROM_KILLS_INTERCEPT");
	...
	m_fLEAGUE_PROJECT_REWARD_TIER_1_THRESHOLD = getDefineINT("LEAGUE_PROJECT_REWARD_TIER_1_THRESHOLD");
	m_fLEAGUE_PROJECT_REWARD_TIER_2_THRESHOLD = getDefineINT("LEAGUE_PROJECT_REWARD_TIER_2_THRESHOLD");

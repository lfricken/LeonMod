...
// -- floats --
	...
	m_fINTERCEPTION_DAMAGE_MULTIPLIER(0.50),
	...
	m_fPOLICY_COST_MULTIPLIER(1.00f),
...
void CvGlobals::cacheGlobals()
{
	...
	m_fINTERCEPTION_DAMAGE_MULTIPLIER = getDefineFLOAT("INTERCEPTION_DAMAGE_MULTIPLIER");
	...
	m_fPOLICY_COST_MULTIPLIER = getDefineFLOAT("POLICY_COST_MULTIPLIER");

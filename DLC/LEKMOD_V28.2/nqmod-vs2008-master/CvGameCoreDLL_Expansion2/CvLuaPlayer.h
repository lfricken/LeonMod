...
protected:
	...
	static int lGetTopPanelTrophys(lua_State* L);
	static int lGetTooltipTopPanelTrophys(lua_State* L);
	...
	static int lGetPolicyRebate(lua_State* L);
	...
	static int lGetTeamDiplomaticInfluencePerTurn(lua_State* L);

	static int lGetScientificInfluence(lua_State* L);
	static int lGetScientificInfluenceNeeded(lua_State* L);
	static int lGetScientificInfluencePerTurn(lua_State* L);
	...
	static int lGetInvestGoldGift(lua_State* L);
#ifdef NQ_BELIEF_TOGGLE_ALLOW_FAITH_GIFTS_TO_MINORS

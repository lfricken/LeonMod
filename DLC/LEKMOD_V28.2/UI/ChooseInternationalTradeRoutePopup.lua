...
function RefreshData()
	...
	local BonusTips = 
	{
		...
		[YieldTypes.YIELD_GOLDEN] = 	"TXT_KEY_CHOOSE_INTERNATIONAL_TRADE_ROUTE_ITEM_GOLDEN",

		[YieldTypes.YIELD_TOURISM] = 	"TXT_KEY_CHOOSE_INTERNATIONAL_TRADE_ROUTE_ITEM_CULTURAL_INFLUENCE",
		[YieldTypes.YIELD_SCIENTIFIC_INSIGHT] = "TXT_KEY_CHOOSE_INTERNATIONAL_TRADE_ROUTE_ITEM_SCIENTIFIC_INFLUENCE",
		[YieldTypes.YIELD_DIPLOMATIC_SUPPORT] = "TXT_KEY_CHOOSE_INTERNATIONAL_TRADE_ROUTE_ITEM_DIPLOMATIC_INFLUENCE",
	}
